...
def test_argmax_dtypes(device, dtype):
    ...
    # some of these.
    src = sfnp.device_array(device, [4, 16, 32], dtype=dtype)
    sfnp.argmax(src)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (sfnp.float8_e4m3_fnuz, sfnp.trunc, math.trunc),
    ],
)
...
# TODO(vinayakdsci): Check why sfnp.float8_e4m3_fnuz
